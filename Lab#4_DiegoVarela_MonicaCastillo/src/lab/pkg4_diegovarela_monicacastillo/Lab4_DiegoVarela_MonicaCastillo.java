                                    ...
                                    case 1:
                                        ...
                                        switch (op) {
                                            case 1:
                                                ...
                                                System.out.println("5) Nave Espacial");
                                                System.out.println("6) Cohete");
                                                int opc0 = entrada.nextInt();
                                                switch (opc0) {
                                                    case 1:
                                                        System.out.print("Ingrese el color de piel del mono: ");
                                                        String color0 = entrada.next();
                                                        System.out.print("Ingrese la cantidad de comida que consume: ");
                                                        int consumo0 = entrada.nextInt();
                                                        System.out.print("Ingrese el planeta de salida: ");
                                                        String planeta0 = entrada.next();
                                                        System.out.print("Ingrese el lugar de nacimiento: ");
                                                        String nacimiento0 = entrada.next();
                                                        System.out.println("¡Bienvenido al Sistema de Registro!");
                                                        System.out.print("Ingrese su nombre: ");
                                                        String nomb0 = entrada.nextLine();
                                                        System.out.print("Ingrese su grupo sanguineo:");
                                                        String sanguineo0 = entrada.next();
                                                        System.out.println("***Genero***");
                                                        System.out.println("1. Femenino");
                                                        System.out.println("2. Masculino");
                                                        System.out.print("Ingrese su genero: ");
                                                        int opcio0 = entrada.nextInt();
                                                        String sexo0 = "";
                                                        switch (opcio0) {
                                                            case 1:
                                                                sexo0 = "Femenino";
                                                        ...
                                                        primates.add(new Mono(color0, 100, consumo0, planeta0, nacimiento0, nomb0, sanguineo0, sexo0, altura3, peso3));
                                                        break;
                                                    case 2:
                                                        ...
                                                        double peso4 = entrada.nextDouble();
                                                        try {
                                                            primates.add(new Gorila(iq, 100, consumo2, planeta2, nacimiento2, nomb3, sanguineo3, sexo3, altura4, peso4));
                                                    ...
                                                    if (primates.get(po) instanceof Mono) {
                                                        ...
                                                        switch (oop) {
                                                            case 1:
                                                                ...
                                                                ((Mono) primates.get(po)).setColor(color1);
                                                                break;
                                                            case 2:
                                                                System.out.println("Ingrese el planeta asignado:");
                                                                String planeta1 = entrada.next();
                                                                ((Mono) primates.get(po)).setPlaneta(planeta1);
                                                                break;
                                                            case 3:
                                                            ...
                                                            case 4:
                                                                ...
                                                                String nomb1 = entrada.next();
                                                                ((Mono) primates.get(po)).setNombre(nomb1);
                                                                break;
                                                            case 5:
                                                            ...
                                                            case 6:
                                                                ...
                                                                ((Mono) primates.get(po)).setSexo(sexo4);
                                                                break;
                                                            case 7:
                                                        ...
                                                        switch (oop) {
                                                            ...
                                                            case 2:
                                                                System.out.println("Ingrese el planeta asignado:");
                                                                String planeta2 = entrada.next();
                                                                ((Gorila) primates.get(po)).setPlaneta(planeta2);
                                                                break;
                                                            case 3:
                                                                System.out.println("Ingrese el lugar de nacimiento del mono:");
                                                                String nacimien = entrada.next();
                                                            ...
                                                            case 4:
                                                                System.out.println("Ingrese el nombre del mono:");
                                                                String nomb2 = entrada.next();
                                                                ((Gorila) primates.get(po)).setNombre(nomb2);
                                                                break;
                                                            case 5:
                                                                System.out.println("Ingrese el grupo sanguineo del mono:");
                                                                String sangre = entrada.next();
                                                            ...
                                                            case 6:
                                                                ...
                                                                ((Gorila) primates.get(po)).setSexo(sexo3);
                                                                break;
                                                            case 7:
                                                                System.out.println("Ingrese la altura del mono:");
                                                                double altu = entrada.nextDouble();
